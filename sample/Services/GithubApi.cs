...
public class GithubApi
{
    ...
    public virtual async Task<string> GetLoginName()
    {
        ...
        {
            throw new CLIException($"Failed to lookup the login for current user", ex);
        }
    }
    ...
    public virtual async Task<string> GetOrganizationId(string org)
    {
        ...
        {
            throw new CLIException($"Failed to lookup the Organization ID for organization '{org}'", ex);
        }
    }
    ...
    public virtual async Task<string> GetEnterpriseId(string enterpriseName)
    {
        ...
        {
            throw new CLIException($"Failed to lookup the Enterprise ID for enterprise '{enterpriseName}'", ex);
        }
    }
    ...
    public virtual async Task<(string State, string SourceOrgUrl, string TargetOrgName, string FailureReason, int? RemainingRepositoriesCount, int? TotalRepositoriesCount)> GetOrganizationMigration(string migrationId)
    {
        ...
        {
            throw new CLIException($"Failed to get migration state for migration {migrationId}", ex);
        }
    }
    ...
    public virtual async Task<(string MigrationLogUrl, string MigrationId)?> GetMigrationLogUrl(string org, string repo)
    {
        ...
        {
            throw new CLIException($"Failed to get migration log URL.", ex);
        }
    }
    ...
    public virtual async Task<IEnumerable<Mannequin>> GetMannequins(string orgId)
    {
        ...
        {
            throw new CLIException($"Failed to retrieve the list of mannequins", ex);
        }
    }
    ...
    public virtual async Task<ReattributeMannequinToUserResult> ReclaimMannequinSkipInvitation(string orgId, string mannequinId, string targetUserId)
    {
        ...
        catch (CLIException ex) when (ex.Message.Contains("Field 'reattributeMannequinToUser' doesn't exist on type 'Mutation'"))
        {
            throw new CLIException($"Reclaiming mannequins with the--skip - invitation flag is not enabled for your GitHub organization.For more details, contact GitHub Support.", ex);
        }
    }
    ...
    public virtual async Task<bool> AbortMigration(string migrationId)
    {
        ...
        catch (CLIException ex) when (ex.Message.Contains("Could not resolve to a node", StringComparison.OrdinalIgnoreCase))
        {
            throw new CLIException($"Invalid migration id: {migrationId}", ex);
        }
    }
